...
public class VisiteController {
	...
	@GetMapping("/trouverVisitesParIdDetenuEtMoisEtAnnee/{id}/{anneeVisite}/{moisVisite}")
	public ApiResponse<Visite> trouverVisitesParIdDetenuEtMoisEtAnnee(@PathVariable("id") String id,
