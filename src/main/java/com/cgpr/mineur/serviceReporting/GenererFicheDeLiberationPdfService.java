...
public interface GenererFicheDeLiberationPdfService {
     ...
     ByteArrayInputStream genererFicheDeLiberationPdf( PDFPenaleDTO pDFPenaleDTO )throws DocumentException, IOException, ArabicShapingException;
