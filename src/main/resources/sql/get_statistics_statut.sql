...
etablissement_situation_judiciaire AS (SELECT 
        cte.id_enf, 
    ...
    GROUP BY cte.id_enf , cte.ETAFK, cte.statut , libelle_etablissement )

 
SELECT 
    etablissement_id,libelle_etablissement,
...
GROUP BY etablissement_id, libelle_etablissement ,situation_judiciaire_id
ORDER BY libelle_etablissement, situation_judiciaire_id